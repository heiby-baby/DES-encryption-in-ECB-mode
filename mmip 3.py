# Лабораторная работа № 3 (Шифр DES)
# Задание №3.1
# Реализовать стандарт шифрования данных DES в режиме «Электронная кодовая книга».
...
def crypt(m, key, encrypt = True):
    ...
    if(encrypt == True):
        ...
        keys.reverse()  # Изменяет список на месте, делая его в обратном порядке
...
if __name__ == "__main__":
    ...
    encrypted_text = crypt(text, key)
    decrypted_text = crypt(encrypted_text, key, False)
